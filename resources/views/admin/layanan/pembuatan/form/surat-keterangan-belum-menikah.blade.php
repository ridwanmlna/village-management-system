...
<head>
    <meta charset="UTF-8">
    <title>Surat Keterangan Belum Menikah {{ $data->nomor_surat }}</title>
    <style>
        body {
...
<!-- JUDUL SURAT -->
<h3 class="judul-surat">Surat Keterangan Belum Menikah</h3>
...
<div class="isi">
    ...
    <br><p class="indent" style="margin-top:10px;"> Adalah benar warga kami yang tersebut di atas sampai saat ini berstatus belum menikah (lajang) dan belum pernah melakukan pernikahan dengan siapapun. </p>
