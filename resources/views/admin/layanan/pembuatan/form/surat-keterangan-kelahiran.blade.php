...
<head>
    <meta charset="UTF-8">
    <title>Surat Keterangan Kelahiran {{ $data->nomor_surat }}</title>
    <style>
        body {
...
<div class="isi">
    ...
    <br><p class="indent" style="margin-top:10px;"> Adalah benar telah lahir seorang anak dari keluarga tersebut di atas, yang merupakan warga Desa Margalaksana Kecamatan Sukaraja Kabupaten Tasikmalaya. </p>
