...
<head>
    <meta charset="UTF-8">
    <title>Surat Keterangan Kematian {{ $data->nomor_surat }}</title>
    <style>
        body {
...
<!-- JUDUL SURAT -->
<h3 class="judul-surat">Surat Keterangan Kematian</h3>
...
<div class="isi">
    ...
    <br><p class="indent" style="margin-top:10px;"> Adalah benar warga kami yang tersebut di atas telah meninggal dunia, yang merupakan warga Desa Margalaksana Kecamatan Sukaraja Kabupaten Tasikmalaya. </p>
