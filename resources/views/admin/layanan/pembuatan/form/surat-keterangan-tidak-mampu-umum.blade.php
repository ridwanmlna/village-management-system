...
<head>
    <meta charset="UTF-8">
    <title>Surat Keterangan Tidak Mampu (SKTM) Umum {{ $data->nomor_surat }}</title>
    <style>
        body {
        ...
        .isi p:first-of-type { margin-top: -15px !important; }
...
<div class="kop-container">
    ...
    <div class="kop-text">
        ...
        <span class="kop-alamat">
            Kantor: Jln. Tambakbaya RT 016 RW 005 Desa Margalaksana Kecamatan Sukaraja Kabupaten Tasikmalaya
        </span>
    </div>
...
<div class="isi">
    ...
    <p class="indent">
        Orang tersebut di atas adalah benar warga kami, warga Desa Margalaksana Kecamatan Sukaraja Kabupaten Tasikmalaya,
        dari Catatan Kependudukan yang ada data orang tersebut diatas termasuk <b><i>Kategori
        Keluarga Tidak Mampu</i></b> <i>dan Surat Keterangan ini kami buat untuk perceraian.</i>
    </p>
