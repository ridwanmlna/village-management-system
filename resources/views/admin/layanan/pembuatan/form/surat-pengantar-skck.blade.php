...
<head>
    <meta charset="UTF-8">
    <title>Surat Pengantar SKCK {{ $data->nomor_surat }}</title>
    <style>
        body {
...
<!-- JUDUL SURAT -->
<h3 class="judul-surat">Surat Pengantar SKCK</h3>
...
<div class="isi">
    ...
    <br><p class="indent" style="margin-top:10px;">
        Adalah benar warga kami, warga Desa Margalaksana Kecamatan Sukaraja Kabupaten Tasikmalaya dan surat pengantar ini dibuat untuk keperluan permohonan SKCK.
    </p>
