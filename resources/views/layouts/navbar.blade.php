<nav class="navbar navbar-expand-lg navbar-light bg-light py-4" style="z-index: 2;">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="{{ route('wellcome') }}">
            <img src="{{ asset('img/Picture1.png') }}" class="d-inline-block" width="50" height="50" alt="">
            <div class="d-flex flex-column ml-3">
                <span class="text-bold text-sm">DESA</span>
<span class="text-bold text-sm">MARGALAKSANA</span>
