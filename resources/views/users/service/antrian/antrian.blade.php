        ...
        @else
            ...
            <form method="POST" action="{{ route('antrian.store') }}">
                ...
                <div class="d-flex w-100 justify-content-end mt-5">
                    ...
                    onclick="return confirm('Apakah anda yakin ingin mengajukan antrian surat ini?\nPastikan data yang anda masukkan sudah benar\nAnda tidak dapat mengubah data setelah mengajukan antrian surat ini.')">Selanjutnya</button>
                </div>
            </form>
